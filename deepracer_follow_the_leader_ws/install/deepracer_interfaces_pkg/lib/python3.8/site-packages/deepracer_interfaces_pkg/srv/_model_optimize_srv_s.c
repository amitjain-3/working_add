...
bool deepracer_interfaces_pkg__srv__model_optimize_srv__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deepracer_interfaces_pkg.srv._model_optimize_srv.ModelOptimizeSrv_Request", full_classname_dest, 73) == 0);
  }
  deepracer_interfaces_pkg__srv__ModelOptimizeSrv_Request * ros_message = _ros_message;
  {  // model_name
  ...
  {  // training_algorithm
    ...
    ros_message->training_algorithm = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // img_format
...
{
  /* NOTE(esteve): Call constructor of ModelOptimizeSrv_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deepracer_interfaces_pkg.srv._model_optimize_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelOptimizeSrv_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool deepracer_interfaces_pkg__srv__model_optimize_srv__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deepracer_interfaces_pkg.srv._model_optimize_srv.ModelOptimizeSrv_Response", full_classname_dest, 74) == 0);
  }
  deepracer_interfaces_pkg__srv__ModelOptimizeSrv_Response * ros_message = _ros_message;
  {  // artifact_path
    PyObject * field = PyObject_GetAttrString(_pymsg, "artifact_path");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->artifact_path, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // error
...
{
  /* NOTE(esteve): Call constructor of ModelOptimizeSrv_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deepracer_interfaces_pkg.srv._model_optimize_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelOptimizeSrv_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // artifact_path
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->artifact_path.data,
      strlen(ros_message->artifact_path.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "artifact_path", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
