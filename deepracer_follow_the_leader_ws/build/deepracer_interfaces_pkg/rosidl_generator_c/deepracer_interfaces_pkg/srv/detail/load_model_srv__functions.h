...
#ifndef DEEPRACER_INTERFACES_PKG__SRV__DETAIL__LOAD_MODEL_SRV__FUNCTIONS_H_
#define DEEPRACER_INTERFACES_PKG__SRV__DETAIL__LOAD_MODEL_SRV__FUNCTIONS_H_
...
/// Initialize srv/LoadModelSrv message.
/**
...
/// Finalize srv/LoadModelSrv message.
/**
...
/// Create srv/LoadModelSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Request__init().
...
/// Destroy srv/LoadModelSrv message.
/**
 * It calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Request__fini()
...
/// Initialize array of srv/LoadModelSrv messages.
/**
...
/// Finalize array of srv/LoadModelSrv messages.
/**
 * It calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Request__fini()
...
/// Create array of srv/LoadModelSrv messages.
/**
 * It allocates the memory for the array and calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LoadModelSrv messages.
/**
 * It calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_deepracer_interfaces_pkg
...
/**
 * It calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_deepracer_interfaces_pkg
...
/**
 * It allocates the memory for the array and calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_deepracer_interfaces_pkg
...
/**
 * It calls
 * deepracer_interfaces_pkg__srv__LoadModelSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DEEPRACER_INTERFACES_PKG__SRV__DETAIL__LOAD_MODEL_SRV__FUNCTIONS_H_
