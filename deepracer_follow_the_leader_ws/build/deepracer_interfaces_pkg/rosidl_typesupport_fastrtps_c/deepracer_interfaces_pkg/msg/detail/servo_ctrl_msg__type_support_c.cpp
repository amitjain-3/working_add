...
#include "deepracer_interfaces_pkg/msg/detail/servo_ctrl_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ServoCtrlMsg__ros_msg_type = deepracer_interfaces_pkg__msg__ServoCtrlMsg;
...
size_t get_serialized_size_deepracer_interfaces_pkg__msg__ServoCtrlMsg(
  const void * untyped_ros_message,
...
static uint32_t _ServoCtrlMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deepracer_interfaces_pkg__msg__ServoCtrlMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deepracer_interfaces_pkg
size_t max_serialized_size_deepracer_interfaces_pkg__msg__ServoCtrlMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_deepracer_interfaces_pkg__msg__ServoCtrlMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, msg, ServoCtrlMsg)() {
