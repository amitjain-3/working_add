...
static const _SoftwareUpdateCheckSrv_Request_type_support_symbol_names_t _SoftwareUpdateCheckSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Request)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::SoftwareUpdateCheckSrv_Request_message_type_support_handle;
}
...
static const _SoftwareUpdateCheckSrv_Response_type_support_symbol_names_t _SoftwareUpdateCheckSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_deepracer_interfaces_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv_Response)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::SoftwareUpdateCheckSrv_Response_message_type_support_handle;
}
...
static const _SoftwareUpdateCheckSrv_type_support_symbol_names_t _SoftwareUpdateCheckSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, SoftwareUpdateCheckSrv)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::SoftwareUpdateCheckSrv_service_type_support_handle;
}
