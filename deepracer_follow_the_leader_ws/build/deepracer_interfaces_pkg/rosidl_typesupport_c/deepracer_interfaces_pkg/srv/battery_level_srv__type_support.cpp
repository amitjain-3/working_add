...
static const _BatteryLevelSrv_Request_type_support_symbol_names_t _BatteryLevelSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Request)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::BatteryLevelSrv_Request_message_type_support_handle;
}
...
static const _BatteryLevelSrv_Response_type_support_symbol_names_t _BatteryLevelSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_deepracer_interfaces_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv_Response)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::BatteryLevelSrv_Response_message_type_support_handle;
}
...
static const _BatteryLevelSrv_type_support_symbol_names_t _BatteryLevelSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, BatteryLevelSrv)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::BatteryLevelSrv_service_type_support_handle;
}
