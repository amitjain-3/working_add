...
static const _ModelOptimizeSrv_Request_type_support_symbol_names_t _ModelOptimizeSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Request)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::ModelOptimizeSrv_Request_message_type_support_handle;
}
...
static const _ModelOptimizeSrv_Response_type_support_symbol_names_t _ModelOptimizeSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_deepracer_interfaces_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv_Response)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::ModelOptimizeSrv_Response_message_type_support_handle;
}
...
static const _ModelOptimizeSrv_type_support_symbol_names_t _ModelOptimizeSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, srv, ModelOptimizeSrv)() {
  return &::deepracer_interfaces_pkg::srv::rosidl_typesupport_c::ModelOptimizeSrv_service_type_support_handle;
}
