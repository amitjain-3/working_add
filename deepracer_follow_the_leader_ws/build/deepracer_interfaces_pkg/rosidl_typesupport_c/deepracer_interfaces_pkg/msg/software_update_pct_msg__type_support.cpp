...
static const _SoftwareUpdatePctMsg_type_support_symbol_names_t _SoftwareUpdatePctMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deepracer_interfaces_pkg, msg, SoftwareUpdatePctMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deepracer_interfaces_pkg, msg, SoftwareUpdatePctMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deepracer_interfaces_pkg, msg, SoftwareUpdatePctMsg)() {
  return &::deepracer_interfaces_pkg::msg::rosidl_typesupport_c::SoftwareUpdatePctMsg_message_type_support_handle;
}
