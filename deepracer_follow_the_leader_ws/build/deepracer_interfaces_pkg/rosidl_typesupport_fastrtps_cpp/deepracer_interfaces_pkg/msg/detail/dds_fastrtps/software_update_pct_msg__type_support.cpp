...
#include "deepracer_interfaces_pkg/msg/detail/software_update_pct_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const deepracer_interfaces_pkg::msg::SoftwareUpdatePctMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deepracer_interfaces_pkg::msg::SoftwareUpdatePctMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SoftwareUpdatePctMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deepracer_interfaces_pkg::msg::SoftwareUpdatePctMsg *>(
...
{
  return max_serialized_size_SoftwareUpdatePctMsg(full_bounded, 0);
}

static message_type_support_callbacks_t _SoftwareUpdatePctMsg__callbacks = {
...
static rosidl_message_type_support_t _SoftwareUpdatePctMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SoftwareUpdatePctMsg__callbacks,
...
{
  return &deepracer_interfaces_pkg::msg::typesupport_fastrtps_cpp::_SoftwareUpdatePctMsg__handle;
}
