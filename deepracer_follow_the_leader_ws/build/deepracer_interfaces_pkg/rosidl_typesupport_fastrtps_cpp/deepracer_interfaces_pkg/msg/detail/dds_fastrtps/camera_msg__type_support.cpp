...
#include "deepracer_interfaces_pkg/msg/detail/camera_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deepracer_interfaces_pkg::msg::CameraMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deepracer_interfaces_pkg::msg::CameraMsg & ros_message)
{
  // Member: images
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const deepracer_interfaces_pkg::msg::CameraMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deepracer_interfaces_pkg::msg::CameraMsg *>(
    untyped_ros_message);
...
{
  return max_serialized_size_CameraMsg(full_bounded, 0);
}
...
{
  return &deepracer_interfaces_pkg::msg::typesupport_fastrtps_cpp::_CameraMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deepracer_interfaces_pkg, msg, CameraMsg)() {
  return &deepracer_interfaces_pkg::msg::typesupport_fastrtps_cpp::_CameraMsg__handle;
}
