...
static const _ServoCtrlMsg_type_support_symbol_names_t _ServoCtrlMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deepracer_interfaces_pkg, msg, ServoCtrlMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deepracer_interfaces_pkg, msg, ServoCtrlMsg)),
  }
};
...
{
  return &::deepracer_interfaces_pkg::msg::rosidl_typesupport_cpp::ServoCtrlMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deepracer_interfaces_pkg, msg, ServoCtrlMsg)() {
  return get_message_type_support_handle<deepracer_interfaces_pkg::msg::ServoCtrlMsg>();
}
